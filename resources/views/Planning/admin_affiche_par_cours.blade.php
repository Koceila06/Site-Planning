...
<div class="container">
    <div class="table_prof">
        ...
        <form method="GET" action="{{ route('admin.modif.supp') }}">
            Week <input type="week" name="week"> <input type="text" hidden name="user" value="{{ Request::get('user') }}">
            ...
            <tr>
                ...
                <td>
                    <ul>
                        @foreach($cour->plannings as $planning)
                        <li>
                            <form method="POST" action="{{route('cour.mj.semaine')}}">
                                @csrf
                ...
                <td>
                    <ul>
                        @foreach($cour->plannings as $planning)
                        <li>
                            <form method="POST" action="{{route('cour.supp')}}">
                                @csrf
                                <input value="{{$planning->id }}" name="planning" type="hidden"></input>
